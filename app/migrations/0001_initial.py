    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('NA', 'New arrivals'), ('SA', 'Shoes and accessories'), ('Cl', 'Collections'), ('CT', 'Coat'), ('JS', 'Jackets and suit jackets'), ('SC', 'Sweaters and cardigans'), ('ST', 'Shirts'), ('TR', 'Trousers'), ('JN', 'Jeans'), ('BS', 'Bikins and swimsuits')], max_length=2)),
